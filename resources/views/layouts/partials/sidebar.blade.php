...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ request()->route('mascota') && request()->route('consulta') ? route('veterinario.expedientes.consultas.diagnostico', [request()->route('mascota'), request()->route('consulta')]) : '#' }}">
