...
@section('contenido')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Vista de Expedientes (Administrador)</h6>
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('btn-ver-consultas').addEventListener('click', function() {
            if (selectedMascotaId) {
                window.location.href = `/admin/expedientes/${selectedMascotaId}/consultas`;
            } else {
        ...
        inputBuscador.addEventListener('input', function (e) {
            ...
            timeout = setTimeout(() => {
                fetch(`{{ route('admin.expedientes.buscar') }}?q=${encodeURIComponent(query)}`)
