...
@section('contenido')
    <!-- Botón Volver -->
    <div class="mb-4">
        <a href="{{ route('veterinario.expedientes.consultas.show', [$consulta->mascota->id, $consulta->id]) }}" class="btn btn-light shadow-sm text-primary font-weight-bold btn-sm px-3 rounded-pill">
