...
@section('contenido')
    <!-- Botón Volver -->
    <div class="mb-4">
        <a href="{{ route('veterinario.expedientes') }}" class="btn btn-light shadow-sm text-primary font-weight-bold btn-sm px-3 rounded-pill">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    ...
                    <div class="mt-4 text-right">
                        <a href="{{ route('veterinario.expedientes.consultas.show', [$mascota->id, $consulta->id]) }}" class="btn btn-primary btn-sm rounded-pill px-4 shadow-sm font-weight-bold">
